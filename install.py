...
rDownloadURL = {"main": "https://github.com/iptvbosna/Xtream-UI-install/raw/main/main_xui_sehara.zip", "sub": "https://github.com/iptvbosna/Xtream-UI-install/raw/main/sub_xui_sehara.zip"}
...
def install(rType="MAIN"):
    ...
    if os.path.exists("/tmp/xtreamcodes.zip"):
        ...
        # OVDJE NOVI KOD
        if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/start_services.sh"):
            os.system('wget -q "https://github.com/iptvbosna/Xtream-UI-install/raw/main/start_services.sh" -O /home/xtreamcodes/iptv_xtream_codes/start_services.sh')
            os.system("sudo chmod +x /home/xtreamcodes/iptv_xtream_codes/start_services.sh")
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        ...
        rlink = input('Example: https://github.com/iptvbosna/Xtream-UI-install/raw/main/release_22f.zip\n\nNow enter the link:\n\n')
    else:
        rlink = "https://github.com/iptvbosna/Xtream-UI-install/raw/main/release_22f.zip"
...
def mysql(rUsername, rPassword, ssh_pwd):
    global rMySQLCnf
    encoded_ssh = base64.b64encode(base64.b64encode(ssh_pwd.encode('utf-8'))).decode('ascii')
...
def configure():
    ...
    # Legacy /etc/init.d/xtreamcodes blok isključen
    if False:
    ...
    try: os.remove("/usr/bin/ffprobe")
    except: pass
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/tv_archive"): os.mkdir("/home/xtreamcodes/iptv_xtream_codes/tv_archive/")
    os.system("ln -s /home/xtreamcodes/iptv_xtream_codes/bin/ffmpeg /usr/bin/")
    os.system("ln -s /home/xtreamcodes/iptv_xtream_codes/bin/ffprobe /usr/bin/")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://github.com/iptvbosna/Xtream-UI-install/raw/main/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://github.com/iptvbosna/Xtream-UI-install/raw/main/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
...
def start(first=True):
    if first:
        ...
        os.system("sudo /home/xtreamcodes/iptv_xtream_codes/start_services.sh >/dev/null 2>&1")
    else:
...
if __name__ == "__main__":
    ...
    printc("XtreamUI 22f Ubuntu %s - Mod sehara" % rVersion, col.GREEN, 2)
    print(" ")
    ...
    if rType.upper() in ["MAIN", "LB"]:
        ...
        if len(rHost) > 0 and len(rPassword) > 0 and rServerID > -1:
            ...
            if input("  ").upper() == "Y":
                ...
                if rType.upper() == "MAIN":
                    if not mysql(rUsername, rPassword, ssh_pwd): sys.exit(1)
