...
``` 
sudo apt update && sudo apt full-upgrade -y && rm -rf install.py && wget https://github.com/iptvbosna/Xtream-UI-install/raw/main/install.py && sudo python3 install.py 
```
## 📡 Streaming URLs
| Platform | URL Format |
|----------|------------|
